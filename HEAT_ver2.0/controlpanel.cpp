...
{
    if(ui->comboBox->currentText()=="Hayabusa2") emit showCaliSignal();
    if(ui->comboBox->currentText()=="Hera") emit showCali_tiriSignal();
...
void Controlpanel::on_showReadTxtButton_clicked()
{
    emit showReadTxtSignal();
}
