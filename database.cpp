...
//Your Database path
//If you use database function, you should set path of TIR_DATA_original
QString rawimagedirectorypath="~/TIR_DATA_original";
bool all = false;
...
void Database::connectDB() {
    ...
    //You should set your DB information.
